...
// Example: 0=IDLE, 3,=PLAYING, 4=LOOPING, 5=PAUSED, 6=STOPPED, 7=CUE BUTTON DOWN, 8=PLATTER DOWN,
// 9=FFWD, 10=FFRV, 11=HOLD
...
pub struct RequestData {
    pub data_type: RequestDataType,         // Data Type
    pub layer: LayerId,                          // Layer where data belongs to
}
